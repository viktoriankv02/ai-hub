...
const network = await onchain.provider.getNetwork();
...
console.log(JSON.stringify({
  ...
  completionId: result.completion.attestation
    ? `${result.completion.attestation.jobId}:${result.completion.attestation.resultHash}`
    : "stored-publication",
